package com.example.uberv.piri_processor;
...
/**
 * Processes {@link com.example.uberv.piri_annotation.NewIntent} annotation
 */
public class NewIntentProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        try {
             ...
             */
            JavaFile.builder("com.example.uberv", navigatorClass.build()).build().writeTo(filer);
